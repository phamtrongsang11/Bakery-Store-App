...
<html lang="en" style="height: auto;">
		...
		<div class="wrap clearfix">
			...
			<div class="user_form" style="margin-bottom: 50px;">
				<div class="card_form" style="height: auto;">
					...
					<div class="card-body">
						<form class="form-horizontal" action="../customer/checkLogin.php" onsubmit="return formValidation();" method="post">
							<div class="row_form"> 
							...
							<div class="float-right" style="margin-right: 20px; margin-top: 20px;">
								<input type="submit" value="Đăng nhập" name="login" class="btn regis_btn">
							</div>
							</div>
						</form>
						<div class="pass_register">
							<a href="index.php?id=5&position=top" type="button">Bạn chưa có tài khoản?</a>
						</div>
					</div>
				</div>
			</div>
	...
	?>
	<script>
			var cusID=document.getElementById("username");
			var password=document.getElementById("password");

			var cusIDErr=document.getElementById("usernameErr");

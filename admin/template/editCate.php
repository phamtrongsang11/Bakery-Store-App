...
<body>
    ...
    <div class="formCate">
        <form action="template/actCate.php?id=<?php if(isset($id)) echo $id ?>" method="post" enctype="multipart/form-data">
        <fieldset class="new">
                <legend class="w-auto">Cập Nhật Loại</legend>
            ...
            <div>
                <textarea type="text" id="des" name="des"rows='4' cols="50" value="" class="form-control" ><?php if(isset($des)) echo $des; ?></textarea>
            </div>
            <div style="margin-top: 2rem;">
                ...
                <div id="divOutput">
                    <img id="output" class="img" src="<?php if(isset($image)) echo "../images/category/$image"?>">
                </div>
            </div>

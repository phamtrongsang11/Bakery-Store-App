...
<div>
    ...
    ?>
    <div class="block-title mb-3"><h3><span>Chi Tiết Phiếu Nhập Kho</span></h3></div>
    <h5>ID Phiếu Nhập: <?php echo $id ?></h5>
	...
	<tbody>
    <?php   
        if($result=ReceiveNote::getDetail($id)){
        $i=1;
        $totalAmount=0;
        $totalPrice=0;
        ...
        ?>
            <tr>
                ...
                <td><?php echo number_format($price, 0, ',', '.') . '₫';    //echo $price?></td>
                <td><?php echo $amount ?></td>
                <td><?php echo number_format($subTotal, 0, ',', '.') . '₫';    //echo $subTotal?></td>
            </tr>
    <?php   
                }
            }
    ...
    ?>
            <tr>
                ...
                <td><?php echo number_format($totalPrice, 0, ',', '.') . '₫';     //echo $totalPrice?></td>
            </tr>
	</tbody>
    </table>
    <?php 

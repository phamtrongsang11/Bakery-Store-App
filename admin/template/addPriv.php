...
<body>
    ...
    <div class="formCate">
        <form  action="template/actPriv.php" method="post">
        <fieldset class="new">
                <legend class="w-auto">Thêm Quyền</legend>
            ...
            <label>Danh Mục Chức Năng Thao Tác</label>
                ...
                ?>
                <div class="item_priv">
                    <input type="checkbox" class="custom-control-input" id="<?php echo $row[1] ?>" name="cata[]" value="<?php echo $row[0] ?>">
            ...
            <div class="addBtn"><input style="margin-left: 0" type="submit" class="btn button " name="add" value="Xác Nhận"></div>
        </fieldset>
        </form>

...
<body>
    ...
    <div class="formCate">
        <form action="./template/actdiscount.php" method="post" enctype="multipart/form-data">
            <fieldset class="new">
                <legend class="w-auto">Thêm Chương Trình</legend>
                <div>
                ...
                <div>
                    ...
                    <label for="dateto" style="margin-left: 1rem">Ngày Kết Thúc</label>
